...
loader = DirectoryLoader('/Users/suchanatratanarueangrong/Hackaday/Data',glob="*.txt")
...
#create llm
llm = CTransformers(model="/Users/suchanatratanarueangrong/Mitrphol/streamlit/llama-2-7b-chat.ggmlv3.q4_0.bin",model_type="llama",
